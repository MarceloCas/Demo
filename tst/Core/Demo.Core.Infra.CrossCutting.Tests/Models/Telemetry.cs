...
namespace Demo.Core.Infra.CrossCutting.Tests.Models
{
    public class Telemetry
    {
        ...
        public string GetTelemetryReport()
        {
            ...
            reportStringBuilder.AppendLine($"Total of Memory (Kb) - {TelemetryCollector.GCInfoResult.TotalBytesOfMemory / 1024.0}");
            reportStringBuilder.AppendLine($"Total of Memory (Mb) - {TelemetryCollector.GCInfoResult.TotalBytesOfMemory / 1024.0 / 1024.0}");
