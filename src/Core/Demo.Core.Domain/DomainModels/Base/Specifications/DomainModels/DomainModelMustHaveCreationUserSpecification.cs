...
{
    public class DomainModelMustHaveCreationUserSpecification
        : SpecificationBase<DomainModelBase>,
        IDomainModelMustHaveCreationUserSpecification
    {
        public DomainModelMustHaveCreationUserSpecification(
            IBus bus,
        ...
        {
            return await Task.FromResult(!string.IsNullOrEmpty(entity?.CreationUser));
        }
    }
}
