...
{
    public class InvoiceCSVLineMustHaveInvoiceCodeSpecification
        : SpecificationBase<FileLineViewModel>,
        IInvoiceCSVLineMustHaveInvoiceCodeSpecification
    {
        ...
        {
            return await Task.FromResult(!string.IsNullOrWhiteSpace(entity?.InvoiceCode));
        }
    }
}
