...
{
    public class InvoiceCSVLineMustHaveCustomerGovernamentalDocumentNumberSpecification
        : SpecificationBase<FileLineViewModel>,
        IInvoiceCSVLineMustHaveCustomerGovernamentalDocumentNumberSpecification
    {
        ...
        {
            return await Task.FromResult(!string.IsNullOrWhiteSpace(entity?.CustomerGovernamentalDocumentNumber));
        }
    }
}
