...
{
    public class InvoiceCSVLineMustHaveCustomerNameSpecification
        : SpecificationBase<FileLineViewModel>,
        IInvoiceCSVLineMustHaveCustomerNameSpecification
    {
        public InvoiceCSVLineMustHaveCustomerNameSpecification(
            IBus bus,
        ...
        {
            return await Task.FromResult(!string.IsNullOrWhiteSpace(entity?.CustomerName));
        }
    }
}
